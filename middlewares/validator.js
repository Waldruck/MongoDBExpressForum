...
body('password', 'Password must be in between 8 and 64 characters.').isLength({min: 8, max: 64})];
...
exports.validateStory = [body('title','Must not be empty.').notEmpty().trim().escape(),
